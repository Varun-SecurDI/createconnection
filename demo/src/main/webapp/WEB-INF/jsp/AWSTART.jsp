...
<br><br><br><br><br>
      ...
      <br><br>
      <label for="acid">AWS_ACCOUNT_ID</label>
      <input type ="text" name="acid" placeholder="Input AWS ACCOUNT ID" required/>
      <br><br>
      <label for="email">ADMIN_EMAIL</label>
      <input type ="text" name="email" placeholder="Input Email" required/>
      <br><br>
      <label for="cara">CROSS_ACCOUNT_ROLE_ARN</label>
      <input type ="text" name="cara" placeholder="Input cross account role arn" required/>
      <br><br>
      <label for="e_id">EXTERNAL ID</label>
      <input type ="text" name="e_id" placeholder="Input External ID" required/>
      <br><br>
      <label for="gov">PULL_GOV_REGION_ONLY</label>
      <input type ="text" name="gov" placeholder="Input Yes/No Only" required/>
      <br><br>
      

      <button type="Submit" formaction ="/AWSEND">Submit</button>
