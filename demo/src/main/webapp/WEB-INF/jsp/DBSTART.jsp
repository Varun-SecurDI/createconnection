...
<br><br><br><br><br>
 ...
 <input type ="text" name="uname" placeholder="Input username" required/>
 <br><br>
 <label for="pwd">PASSWORD</label>
 <input type ="password" name="pwd" placeholder="Input password" required/>
 <br><br>
 <label for="dname">DRIVERNAME</label>
 <input type ="text" name="dname" placeholder="Input jdbc drivername" required/>
 <br><br>

 <button type="Submit" formaction ="/DBEND">Submit</button>
